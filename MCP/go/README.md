# Department of Food, Public Distribution & Consumer Affairs (PDS), Jharkhand MCP Server

This MCP (Model Content Protocol) server provides access to Department of Food, Public Distribution & Consumer Affairs (PDS), Jharkhand API functionality through HTTP, HTTPS, and STDIO transport modes.
